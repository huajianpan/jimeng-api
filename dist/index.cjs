...
var ServiceConfig = class _ServiceConfig {
  ...
  constructor(options) {
    ...
    this.port = import_lodash3.default.defaultTo(port, 3e3);
...
function lookupResolution(resolution = "2k", ratio = "1:1") {
...
function resolveResolution(userModel, regionInfo, resolution = "2k", ratio = "1:1") {
  ...
  if (userModel === "nanobanana") {
    if (regionKey === "US") {
      ...
      const params2 = lookupResolution("1k", ratio);
      return {
        width: params2.width,
...
function getBenefitCount(userModel, regionInfo, isMultiImage = false) {
  ...
  const regionKey = getRegionKey(regionInfo);
  if (regionKey === "CN") return void 0;
  if (regionKey === "US") {
    return ["jimeng-4.5", "jimeng-4.0", "jimeng-3.0"].includes(userModel) ? 4 : void 0;
  }
  if (regionKey === "HK" || regionKey === "JP" || regionKey === "SG") {
    if (userModel === "nanobanana") return void 0;
    return 4;
  }
  return void 0;
}
...
function buildPromptPlaceholderList(count) {
  return Array.from({ length: count }, (_18, index) => ({
    type: "",
    id: util_default.uuid(),
    ability_index: index
  }));
...
function getModel(model, isInternational) {
